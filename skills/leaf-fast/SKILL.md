...
seam or two — stop and run `/leaf` instead, or `/leaf-sans` if the work wants the full
rigour but leaves nothing worth documenting. The worktree you're in is already the right
one for it.
